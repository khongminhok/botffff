...
{Fore.YELLOW}║      RIFAT'S FREE FIRE BOT         ║{Fore.RESET}
{Fore.YELLOW}║    Powered by Falcon x64 (Guild)   ║{Fore.RESET}
{Fore.CYAN}╚════════════════════════════════════╝{Fore.RESET}
    """
    for char in banner:
...
def send_likes(uid):
    try:
        likes_api_response = requests.get(
            f"https://like2.vercel.app/like?uid={uid}&server={server2}&key={key2}",
            timeout=15
        )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Credits: [FFFFFF]RIFAT [00FF00]!!
                """
